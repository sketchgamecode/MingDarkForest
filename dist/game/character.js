...
exports.CLASS_DEFINITIONS = void 0;
exports.getXpRequired = getXpRequired;
exports.getStatBonusForLevel = getStatBonusForLevel;
exports.applyLevelBonuses = applyLevelBonuses;
exports.calculateLevel = calculateLevel;
exports.getVisibilityDescription = getVisibilityDescription;
exports.getVisibilityTier = getVisibilityTier;
exports.CLASS_DEFINITIONS = {
    Scholar: {
        name: 'Scholar',
        chineseName: '文士',
...
function applyLevelBonuses(baseStats, level) {
...
function getVisibilityTier(visibility) {
    if (visibility <= 20)
        return 1;
    if (visibility <= 50)
        return 2;
